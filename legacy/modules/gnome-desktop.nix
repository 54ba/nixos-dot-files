...

{
  ...
  config = mkIf config.custom.desktop.gnome.enable {
    # Enable GNOME desktop environment with custom configuration
    services.xserver.desktopManager.gnome = {
      enable = true;
      # GNOME Shell configuration with custom theme (conditional)
